...
namespace Nistec.Caching.Install
{
    ...
    public class wfrm_Install : Form
    {
        ...
        const bool EnableWinformApp = false;
        ...
        public wfrm_Install()
        {
            ...
            else
            {
                if (!IsServiceInstalled())
                {
                    ...
                    m_pRunAsTryApp.Enabled = EnableWinformApp;
                    m_pRunAsWindowsForm.Enabled = EnableWinformApp;
                }
                else
                {
        ...
        private void InitUI()
        {
            ...
            this.Text = "Nistec Server Installer";
        ...
        {
            if(Environment.OSVersion.Platform == PlatformID.Unix){
                System.Diagnostics.Process.Start("mono", Application.StartupPath + "/" + Settings.TrayAppProcess + " -trayapp");
            }
            else{
                System.Diagnostics.Process.Start(Application.StartupPath + "/" + Settings.TrayAppProcess, "-trayapp");
            }
