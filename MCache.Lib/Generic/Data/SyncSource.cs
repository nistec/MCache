...
namespace Nistec.Caching.Data
{
    ...
    public class SyncSourceCollection : List<SyncSource>
    {
        ...
        /// <summary>Appends the specified <see cref="T:MControl.Caching.Data.SyncSource"></see> object to the end of the collection.</summary>
        /// <returns>The index value of the added item.</returns>
        /// <param name="syncsource">The <see cref="T:MControl.Caching.Data.SyncSource"></see> to append to the collection. </param>
        ...
        /// <summary>Creates a <see cref="T:MControl.Caching.Data.SyncSource"></see> object with the specified name and default value, and appends it to the end of the collection.</summary>
        /// <returns>The index value of the added item.</returns>
...
--GO";
        ...
        public int CreateTableTrigger()
        {
            try
            {
                ...
                IDbCmd dbCmd = Owner.dbCmd;// DBFactory.Create(connectionString, MControl.Data.DBProvider.SqlServer);
        ...
        public void StoreTableSource()
        {
            try
            {
                MControl.Caching.CacheLogger.LogWrite("Store Edited : " + this.TableName);
