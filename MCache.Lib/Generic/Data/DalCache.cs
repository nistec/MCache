...
namespace Nistec.Caching.Data
{
    ...
    public class DalCache : System.ComponentModel.Component//, IDataCache
    {
        ...
        //private MControl.Threading.ThreadTimer _timer;  
        ...
        //{
        //    MControl.Net.DalNet.NetFram(pk, "SRV");
        //    DalCacheInternal();
        //}
        ...
        private DalCache(string cacheName)
        {
            ...
            //MControl.Net.DalNet.NetFram("DalCache", "Ctl");
            ...
            //_timer = new MControl.Threading.ThreadTimer(_sleepTime);
        ...
        //        //IDbCmd cmd = MControl.Data.DBUtil.Create(ConnectionString, Provider);
