...
namespace Nistec.Caching.Remote
{
    ...
    public class RemoteData : DalCache, IRemoteData
    {
        ...
        //        if (_DalBase == null)
        //        {
        //            _DalBase = new MControl.Data.Common.DalProvider(MControl.Data.DBProvider.SqlServer, Config.ConnectionString);
        //        }
        //        return _DalBase;
        //    }
        //}
        ...
        public void CreateDataSource(IDalBase dalBase, DalCache storage)
        {
            if (!base.Initilized)
            {
        ...
        {
            IDalBase dal= new DalProvider(DBProvider.SqlServer, connectionString);
        ...
        public void CreateDataSource(IDalBase dalBase, DataSet dataSource, string cahceName)
        {
            ...
            {
                _DalBase = dalBase;
                base.Synchronize(new DalCache(cahceName,dalBase));
        ...
        public void AddDataItem(DataTable dt, string tableName, MControl.Caching.Data.SyncSource syncSource)
        {
        ...
        public void AddDataItem(DataTable dt, string tableName, string mappingName,string sourceName, SyncType syncType, TimeSpan ts)
        {
            if (AddDataItem(dt, tableName))
            {
                base.SyncTables.Add(new SyncSource(tableName, mappingName,sourceName, new SyncTimer(ts, syncType)));
            }
        }
        ...
        /// <param name="syncType"></param>
        /// <param name="minute"></param>
        public void AddDataItem(DataTable dt, string tableName, string mappingName, SyncType syncType, TimeSpan ts)
        {
            if (AddDataItem(dt, tableName))
            {
                base.SyncTables.Add(new SyncSource(tableName, mappingName, mappingName, new SyncTimer(ts, syncType)));
            }
        }
        ...
        /// <param name="syncType"></param>
        /// <param name="ts"></param>
        public void AddSyncItem(string tableName, string mappingName, SyncType syncType, TimeSpan ts)
        {
                base.SyncTables.Add(new SyncSource(tableName, mappingName, mappingName, new SyncTimer(ts, syncType)));
        }
        ...
        /// <param name="syncType"></param>
        /// <param name="ts"></param>
        public void AddSyncItem(string tableName, string mappingName, string sourceName, SyncType syncType, TimeSpan ts)
        {
                base.SyncTables.Add(new SyncSource(tableName, mappingName, sourceName, new SyncTimer(ts, syncType)));
        }
        ...
        /// <param name="tableName"></param>
        /// <param name="syncSource"></param>
        public void AddDataItem(IActiveConfig dt, string tableName, SyncSource syncSource)
        {
            if (AddDataItem(dt, tableName))
            {
                base.SyncTables.Add(syncSource);
        ...
        /// <param name="syncType"></param>
        /// <param name="minute"></param>
        public void AddDataItem(IActiveConfig dt, string tableName, string mappingName,string sourceName, SyncType syncType, TimeSpan ts)
        {
            if (AddDataItem(dt, tableName))
            {
                base.SyncTables.Add(new SyncSource(tableName, mappingName,sourceName, new SyncTimer(ts, syncType)));
        ...
        /// <param name="syncType"></param>
        /// <param name="minute"></param>
        public void AddDataItem(IActiveConfig dt, string tableName, string mappingName, SyncType syncType, TimeSpan ts)
        {
            if (AddDataItem(dt, tableName))
            {
                base.SyncTables.Add(new SyncSource(tableName, mappingName, mappingName, new SyncTimer(ts, syncType)));
        ...
        /// </summary>
        /// <param name="dalBase"></param>
        public RemoteData(string cacheName,AutoDb dalDB)
