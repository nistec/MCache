...
namespace Nistec.Caching.Data
{
    ...
    /// </summary>
    public class DataCacheDb : IDisposable
    {
        ...
        public DataCacheDb(string dbCacheName)
        {
        ...
        public void LoadDbConfig(XmlDocument doc)
        {
            ...
            XmlNode items = doc.SelectSingleNode("//DataCacheDb");
            if (items == null)
                return;
        ...
        internal void Reload(Dictionary<string, DataCache> db)
        {
            if (db == null)
            {
                throw new ArgumentNullException("DataCacheDb.Reload.db");
            }
        ...
        public void Start()
        {
            ...
            _Initialized = true;
            CacheLogger.Logger.LogAction(CacheAction.General, CacheActionState.Debug, "DataCacheDb Started!");
        }
        /// <summary>
        /// Stop dn cache.
        /// </summary>
        public void Stop()
        {
            ...
            _Initialized = false;
            CacheLogger.Logger.LogAction(CacheAction.General, CacheActionState.Debug, "DataCacheDb Stoped!");
        }
        #endregion
        ...
        {
            if (db == null)
                db = CacheDefaults.DefaultBundleHostName;//.DbCacheName;
            DataCache item = null;
        ...
        /// <returns></returns>
        public CacheItemProperties CacheItemProperties(string db, string tableName)
        {
            DataCache item = Get(db);
            if (item == null)
                return null;
            ...
            if (dt == null)
                return null;
            var dtprop = new TableProperties() { RecordCount = dt.Rows.Count, Size = 0, ColumnCount = dt.Columns.Count };
