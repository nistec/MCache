...
namespace Nistec.Caching
{
    ...
    public abstract class GenericCache<K, T> : Dictionary<K, T>
    {
        ...
        protected virtual void SyncData(DataTable dt)
        {
            //this.Clear();
            CreateCache(dt);
        }
        ...
        /// <returns></returns>
        public T FindItemByValue(object value, string field)
        {
            if (value == null)
            {
                return default(T);
            ...
            foreach(var item in this.Values)
            {
                ...
                //                  where p.Name == field && p.CanRead && p.GetValue(item, null) == value
                //                  select p).FirstOrDefault();

                //foreach (var p in typeof(T).GetProperties())
                //{
                //    if(p.CanRead && p.Name==field && p.GetValue(item, null)==value)
                //    {
                //        found = true;
                //        break;
                //    }
        ...
        //protected virtual bool IsMatch(T item, string value)
        //{
        //    return false;
        //}
