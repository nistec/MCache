...
namespace Nistec.Caching.Loader
{
    ...
    public class SyncBagStream :IDisposable 
    {
        ...
        ConcurrentDictionary<string, SyncItemStream> m_data;
       
        /// <summary>
        /// Get all items from sync bag.
        /// </summary>
        /// <returns></returns>
        public SyncItemStream[] GetItems()
        {
        ...
        public SyncBagStream(string cacheName, SyncStream owner)
        {
            Owner = owner;
        ...
        public void Set(SyncItemStream item)
        {
        ...
        ///// <param name="info"></param>
        ///// <param name="value"></param>
        //public void Set(ComplexKey info, ISyncItemStream value)
        //{
