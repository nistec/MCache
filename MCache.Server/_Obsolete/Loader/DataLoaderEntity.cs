...
namespace Nistec.Caching.Loader
{
    ...
    /// </summary>
    public class DataLoaderEntity : IDisposable//IDataLoaderEntity
    {
        public DataLoaderEntity Copy()
        {
            return new DataLoaderEntity()
            {
        ...
        {
            //CacheLogger.Debug("DataLoaderEntity OnSyncSourceChanged : " + e.SourceName);
        ...
        /// <summary>
        ///  Determines whether the specified System.Object is equal to the current DataLoaderEntity.
        /// </summary>
        /// <param name="obj"></param>
        /// <returns></returns>
        public override bool Equals(object obj)
        {
            if (!(obj is DataLoaderEntity))
                return false;
            if (SyncEntity==null)
                return ((DataLoaderEntity)obj).SyncEntity==null;
            if (((DataLoaderEntity)obj).SyncEntity == null)
                return SyncEntity == null;
            return base.Equals(((DataLoaderEntity)obj).SyncEntity.EntityName == SyncEntity.EntityName);
        }
        /// <summary>
...
--GO";
        ...
        private DataLoaderEntity()
        {
        }

        /// <summary>
        /// Initilaize a new instance of <see cref="DataLoaderEntity"/>
        /// </summary>
        /// <param name="entity"></param>
        public DataLoaderEntity(SyncEntity entity)
        {
            if (entity == null)
            {
                throw new ArgumentNullException("DataLoaderEntity.ctor entity");
            }
            SyncEntity = entity;
        ...
        public DataLoaderEntity(SyncEntity entity, SyncTimer syncTimer)
        {
            if (entity == null)
            {
                throw new ArgumentNullException("DataLoaderEntity.ctor entity");
        ...
        public DataLoaderEntity(string entityName, string mappingName, string[] sourceName, SyncType syncType, TimeSpan interval, bool enableNoLock, int commandTimeout)
        {
        ...
        /// <param name="enableNoLock"></param>
        /// <param name="commandTimeout"></param>
        public DataLoaderEntity(string entityName, string mappingName, SyncType syncType, TimeSpan interval, bool enableNoLock=false, int commandTimeout=0)
        {
        ...
        public int Register(IDataCache Owner)
        {
            ...
            try
            {
                ...
                using (var db = Owner.Db())
                {
                    ...
                    foreach (string sn in SyncEntity.SourceName)
                    {
                        ...
                        {
                            CacheLogger.Logger.LogAction(CacheAction.SyncTime, CacheActionState.Error, "DataLoaderEntity Register item error: " + ex.Message);
                        }
                    }
            ...
            {
                CacheLogger.Logger.LogAction(CacheAction.SyncTime, CacheActionState.Error, "DataLoaderEntity Register error: " + ex.Message);
            }
            return res;
        }
        ...
        public int CreateTableTrigger(IDataCache Owner)
        {
            ...
            try
            {
                ...
                using (var db = Owner.Db())
                {
                    ...
                    foreach (string sn in SyncEntity.SourceName)
                    {
                        ...
                        {
                            CacheLogger.Logger.LogAction(CacheAction.SyncTime, CacheActionState.Error, "DataLoaderEntity CreateTableTrigger item error: " + ex.Message);
                        }
                    }
                    db.OwnsConnection = false;
                }
            ...
            {
                CacheLogger.Logger.LogAction(CacheAction.SyncTime, CacheActionState.Error, "DataLoaderEntity CreateTableTrigger error: " + ex.Message);
            }
        ...
        public int ResetAll(IDataCache Owner)
        {
            ...
            {
                CacheLogger.Logger.LogAction(CacheAction.SyncTime, CacheActionState.Error, "DataLoaderEntity ResetAll error: " + ex.Message);
            }
            return 0;
        }
        /// <summary>
        ...
        public int ResetEdited(IDataCache Owner)
        {
            ...
            try
            {
                ...
                using (var db = Owner.Db())
                {
                    ...
                    foreach (string sn in SyncEntity.SourceName)
                    {
                        ...
                        {
                            CacheLogger.Logger.LogAction(CacheAction.SyncTime, CacheActionState.Error, "DataLoaderEntity ResetEdited item error: " + ex.Message);
                        }
                    }
                    db.OwnsConnection = false;
                }
            ...
            {
                CacheLogger.Logger.LogAction(CacheAction.SyncTime, CacheActionState.Error, "DataLoaderEntity ResetEdited error: " + ex.Message);
            }
            return res;
        }
        /// <summary>
        ...
        {
            Console.WriteLine("Debuger-DataLoaderEntity.SyncAndStore...");
