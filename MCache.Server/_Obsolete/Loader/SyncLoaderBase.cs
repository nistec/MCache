...
namespace Nistec.Caching.Loader
{
   ...
   /// <typeparam name="T"></typeparam>
    [Serializable]
    public abstract class SyncLoaderBase<T> : IDisposable//ISyncCacheItem
    {
        ...
        /// <summary>
        /// Create new <see cref="SyncLoaderBase{T}"/>
        /// </summary>
        /// <param name="isAsync"></param>
        public SyncLoaderBase(bool isAsync) 
        {
        ...
        /// <param name="isAsync"></param>
        public SyncLoaderBase(SyncEntity entity, bool isAsync)
            : this(isAsync)
        {

            //Info = new ComplexKey() { ItemKeys = entity.EntityKeys, ItemName = entity.EntityName };
            Info = ComplexKey.Get(entity.EntityName,entity.EntityKeys);

            SyncSource = new DataLoaderEntity(entity);//entity.EntityName, entity.ViewName, entity.SourceName, new SyncTimer(entity.Interval, entity.SyncType));
        ...
        /// <param name="isAsync"></param>
        public SyncLoaderBase(string connectionKey, string entityName, string mappingName, string[] keys, string columns, SyncTimer timer, bool enableNoLock, int commandTimeout, bool isAsync)
            : this(isAsync)
        {
        ...
        /// <param name="commandTimeout"></param>
        /// <param name="isAsync"></param>
        public SyncLoaderBase(string connectionKey, string entityName, string mappingName, string[] sourceName, EntitySourceType sourceType, string[] keys, string columns, SyncTimer timer, bool enableNoLock, int commandTimeout, bool isAsync)
            : this(isAsync)
        {
        ...
        public void Set<Dbc>(string entityName, string mappingName, string[] keys, string columns, SyncTimer timer, bool enableNoLock, int commandTimeout) where Dbc : IDbContext
        {
            ...
            Info = ComplexKey.Get(entityName, keys);
        ...
        public void SetContext(IDbContext db, string entityName, string mappingName, EntitySourceType sourceType, EntityKeys keys, string columns="*")
       {
        ...
        public void Validate()
        {
            ...
            //}
            if (Info.ItemKey == null || Info.ItemKey.Length == 0 || string.IsNullOrEmpty(Info.ItemName))
            {
                throw new Exception("ComplexKey is not valid");
            }
        }
