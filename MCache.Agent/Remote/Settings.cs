...
namespace Nistec.Services
{
    ...
    public class Settings
    {
        ...
        public const string ServiceName = "Nistec.Cache.Agent";
        public const string DisplayName = "Nistec.Cache";
        public const string ServiceDescription = "Nistec Remote Cache Agent";
        ...
        public const string ServiceProcess = "Nistec.Cache.Agent.exe";
        public const string WindowsAppProcess = "Nistec.Cache.Server.exe";
